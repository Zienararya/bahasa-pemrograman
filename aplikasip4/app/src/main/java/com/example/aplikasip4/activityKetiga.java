...
public class activityKetiga extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbarKetiga = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbarKetiga);
        ...
        ListView penutupList = findViewById(R.id.list_view_penutup);
       ...
       penutupList.setAdapter(dishAdapter);

        penutupList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
